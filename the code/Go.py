...
#label
Label(screen, text=" enter text for encryption and decryption ", font="impack 14 bold").place(x=5, y=6)
#Text
text1=Text(screen,font="20")
text1.place(x=5,y=45,width=390,height=120)
#Label
...
#This is a encryption and decryption tool made using base 64 by Derick Gitau
